...
| dioxus-cli | 662cf0d9 | CLI tool for developing, testing, and publishing Dioxus apps. |
...
| linux-xanmod-bore | 6.14.11 | Linux Xanmod (Stable) with BORE CPU scheduler and tickrate customizations |
